...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ", url=f"https://t.me/lggbg"), InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ²", url=f"https://t.me/cecrr")],
        
        [InlineKeyboardButton("المطور", url=f"https://t.me/BDB0B")],
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        [InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ", url=f"https://t.me/lggbg"), InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ²", url=f"https://t.me/lggbg")],
        [InlineKeyboardButton("المطور", url=f"https://t.me/BDB0B")],
        [InlineKeyboardButton(text="اضف البوت الي مجموعتك او قناتك ⚡️", url=f"https://t.me/F6Z_bot?startgroup=True")],
    ]
    return buttons
